...
## Algorithm
1..The dataset is first loaded and cleaned by removing unnecessary spaces, converting the time column into datetime format, sorting the data in chronological order, and filling missing values using interpolation.
...
## Output:
<img width="1233" height="465" alt="image" src="https://github.com/user-attachments/assets/0eca8dba-0d95-4059-b76a-d999d4bb4106" />
<img width="1197" height="462" alt="image" src="https://github.com/user-attachments/assets/c200c2a0-24ab-41e1-87b1-a7f6394db362" />
<img width="1310" height="595" alt="image" src="https://github.com/user-attachments/assets/846474ef-ad44-47cf-8737-afa7e7e20f65" />


## Result:
The Random Forest model successfully predicts temperature, PM2.5 levels, and solar radiation using the given weather data. The model achieves good performance with high R² values and low mean absolute error, indicating accurate predictions. The comparison graphs show that the predicted values closely follow the actual values. Feature importance analysis reveals that lag features and environmental factors like humidity and pressure significantly influence the predictions. The model is also able to generate real-time predictions for the next time step using the latest available data.
